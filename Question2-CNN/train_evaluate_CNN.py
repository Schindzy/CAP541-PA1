...
def run_main(FLAGS):
    ...
    dataset1 = datasets.MNIST('C:/Users/Sean/PycharmProjects/ProgrammingAssignment1/Question2-CNN/data', train=True, download=True,
                       transform=transform)
    dataset2 = datasets.MNIST('C:/Users/Sean/PycharmProjects/ProgrammingAssignment1/Question2-CNN/data', train=False,
                       transform=transform)
